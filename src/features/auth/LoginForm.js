    ...
    <div>
        <AuthLayout>
            ...
            <div className='tw-relative'>
                ...
                <input type="text" className='tw-w-full tw-h-full tw-bg-transparent tw-border tw-border-grey-100 tw-rounded-lg tw-pr-6 tw-pl-9 tw-py-2 placeholder:tw-text-sm tw-text-white tw-outline-none' placeholder='Enter password'/>
            </div>
